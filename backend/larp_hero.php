...
<h4 class="main-title text-center mt-2"><?=$ts[$do];?></h4>
    ...
    <form method="post" action="api/manage.php">
        <table width="100%" class="table table-bordered text-center table-light table-striped align-middle">
            ...
            <?php
                ...
                <tr>
                    ...
                    <td>
                    <input type="button" 
                        value="更換圖片" onclick="location.href='modal/hero_update.php?id=<?=$value['id'];?>'">
                    </td>
        ...
        <?php
            if(($now-1)>0){
                echo "<a href='?do=larp_hero&p=".($now-1)."'> < </a>";
            }

            for($i=1;$i<=$pages;$i++){
                $fontsize=($now==$i)?'24px':'16px';
                echo "<a href='?do=larp_hero&p=$i' style='font-size:$fontsize'> $i </a>";
            }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modelLable"><?=$hs['larp_hero'];?></h5>
            ...
            <form action="api/manage.php" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <table style="margin:auto;">
                        <tr class="mb-3">
                            <td style="text-align:right"><?=$hs['larp_hero'];?>：</td>
